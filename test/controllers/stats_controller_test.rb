...
class StatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stat" do
    assert_difference('Stat.count') do
      post stats_url, params: { stat: { mvp_wins: @stat.mvp_wins, noms_received: @stat.noms_received, noms_sent: @stat.noms_sent, user_id: @stat.user_id } }
    end
  ...
  test "should update stat" do
    patch stat_url(@stat), params: { stat: { mvp_wins: @stat.mvp_wins, noms_received: @stat.noms_received, noms_sent: @stat.noms_sent, user_id: @stat.user_id } }
